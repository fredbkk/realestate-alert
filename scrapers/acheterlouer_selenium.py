...
BASE_URL = "https://www.acheter-louer.ch/fr/maison-a-vendre/vaud/bussigny"
SEEN_FILE = "seen_acheterlouer.json"
...
def fetch():
    ...
    ads = driver.find_elements(By.CSS_SELECTOR, "div.property-item > a")
...
if __name__ == "__main__":
    log("🧭 Surveillance Acheter-Louer...")
    r = fetch()
